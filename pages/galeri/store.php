...
if (in_array($file_ext, $allowed_file_types)) {
	...
	if (file_exists("../../assets/upload/" . $newfilename)) {
		...
		// query
		$query = "INSERT INTO `galeri` (`path_galeri`, `caption_galeri`, `tautan_galeri`, `id_user`, `judul_galeri`) VALUES ('$path_galeri', '$caption_galeri', '$tautan_galeri', '$id_user', '$judul_galeri');";
